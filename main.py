            ...
            ## Checking if keys are being pressed
                ...
                if input_box1.active or input_box2.active or input_box3.active:
                    ...
                    if event.key == pg.K_RETURN:
                        ...
                        # if codeBox != True:
                        #     input_box2.active = False
                        #     input_box2.color = COLOR_INACTIVE
                        #     input_box2.image = pg.image.load("GUI/TEXTBOX.png").convert_alpha()
                        #     # Change the current color of the input box.
                        #     input_box1.active = not input_box1.active
                        #     input_box1.color = COLOR_ACTIVE
                        #     input_box1.image = pg.image.load("GUI/TEXTBOX_MEDIUM_ACTIVE.png").convert_alpha()
                                                    
                        # elif codeBox1 != True:                            
                        #     input_box1.active = False
                        #     input_box1.color = COLOR_INACTIVE
                        #     input_box1.image = pg.image.load("GUI/TEXTBOX_MEDIUM.png").convert_alpha()
                        #     # Change the current color of the input box.
                        #     input_box3.active = not input_box3.active
                        #     input_box3.color = COLOR_ACTIVE
                        #     input_box3.image = pg.image.load("GUI/TEXTBOX_SMALL_ACTIVE.png").convert_alpha()  
                            
                        # else:
                        #     input_box3.active = False
                        #     input_box3.color = COLOR_INACTIVE
                        #     input_box3.image = pg.image.load("GUI/TEXTBOX_SMALL.png").convert_alpha()
                            
                        #     if int(input_box3.text) >= 17:
                        #         input_box3.text = 16
                        #     if len(currentStack) != 0:
                        #         for c in currentStack:
                        #             if input_box1.text == c:
                        #                 input_box1.text = ''
                        ...
                        #                     if i.type == "button":
                        #                         if i.job =="cardCreate":
                        #                             i.image = pg.image.load("GUI/ADD.png").convert_alpha()
                        #                             i.active = True
                        #                 break
                        #             else:
                                        # Button.captaButton(CaptchaCards, sprites, layers, input_box1.text, input_box2.text, currentStack, int(input_box3.text))
                        ...
                        # if codeBox == False:
                        #     codeBox = True
                        # elif codeBox == True and codeBox1 == False:
                        #     codeBox1 = True  
                        # else:      
                        #     codeBox = False
                        #     codeBox1 = False        
