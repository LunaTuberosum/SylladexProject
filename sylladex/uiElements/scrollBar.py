    ...
    def __init__(self):
        if len(UIElement.get_ui_elem('CardList').get_list()) == 0:
            ...
            if len(UIElement.get_ui_elem('CardList').get_list()) > 9:
                _sections = 625 / len(UIElement.get_ui_elem('CardList').get_list()) 
                _size = _sections * 8
            else:
                _size = 0
    ...
    def move_bar(self, pos):
        ...
        if self.rect.y < 196:
            ...
            for _list_obj in UIElement.get_ui_elem('CardList').get_list():
                _list_obj.rect.y = 196 + (70 * UIElement.get_ui_elem('CardList').get_list().index(_list_obj))
            ...
            for _list_obj in UIElement.get_ui_elem('CardList').get_list():
                _list_obj.rect.y = 196 - (70 * ((len(UIElement.get_ui_elem('CardList').get_list())-9) - UIElement.get_ui_elem('CardList').get_list().index(_list_obj)))
                if _list_obj.children:
                    _list_obj.place_children()
